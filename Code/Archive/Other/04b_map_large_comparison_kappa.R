...
map(c("landward", "seaward",
  ...
  map(c("country_and_biotyp", "biotyp"), function(split_group) {
    ...
    dir.create(paste0("Results/RDS/prioritisation/Country/04b_comparison/",
                      split_group, "/",
                      CC_direction), recursive = TRUE)

    saveRDS(comparison_solution, paste0("Results/RDS/prioritisation/Country/04b_comparison/",
                                        split_group, "/",
                                        CC_direction, "/Comparison_large_",
                                        as.character(prct), "_", CC_direction, "_kappa.RDS"))

    dir.create(paste0("Results/gpkg/prioritisation/Country/04b_comparison/",
                      split_group, "/",
                      CC_direction), recursive = TRUE)

    st_write(comparison_solution, paste0("Results/gpkg/prioritisation/Country/04b_comparison/",
                                         split_group, "/",
                                         CC_direction, "/Comparison_large_",
