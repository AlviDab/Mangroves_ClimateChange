...
dir.create(paste0("Figures/Country/06a_plot_diff_area_resilience/", CC_direction, "/RDS"), recursive = TRUE)

ggsave(plot = plot, paste0("Figures/Country/06a_plot_diff_area_resilience/", CC_direction, "/diff_area_resilience_",
                           CC_direction, "_by_country_", prct, ".pdf"),
       dpi = 300, width = 18, height = 10, units = "cm")

saveRDS(plot, paste0("Figures/Country/06a_plot_diff_area_resilience/", CC_direction, "/RDS/diff_area_resilience_",
                     CC_direction, "_by_country_", prct, ".rds"))

saveRDS(plot_legend, paste0("Figures/Country/06a_plot_diff_area_resilience/", CC_direction, "/RDS/diff_area_resilience_",
                            CC_direction, "_by_country_", prct, "_legend.rds"))

write.xlsx(plot_layer %>%
             st_drop_geometry(), paste0("Figures/Country/06a_plot_diff_area_resilience/", CC_direction, "/diff_area_resilience_",
