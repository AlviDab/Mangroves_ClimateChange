...
resilience_boxplot <- readRDS(paste0("Figures/Country/03a_resilience/",
                                     split_group, "/RDS/boxplot_resilience_",
                                     CC_direction, "_", prct, ".rds")) +
  theme(legend.position = "none")

area_boxplot <- readRDS(paste0("Figures/Country/02a_area/",
...
dir.create("Figures/Country/13b_patchwork_boxplot_investment/", recursive = TRUE)

ggsave(plot = figure_02, paste0("Figures/Country/13b_patchwork_boxplot_investment/patchwork_boxplot_investment_mean_", prct, ".pdf"),
       dpi = 300, width = 18, height = 27, units = "cm")

ggsave(plot = figure_02, paste0("Figures/Country/13b_patchwork_boxplot_investment/patchwork_boxplot_investment_mean_", prct, ".jpg"),
       dpi = 300, width = 18, height = 27, units = "cm")
