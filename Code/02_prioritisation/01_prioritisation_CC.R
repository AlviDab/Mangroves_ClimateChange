...
PUs <- readRDS(paste0("Results/RDS/crop/prioritisation_input/PUs_05_mangroves_cc_IUCN_split_by_MEOW_and_biotyp_crop_priority_", 
       prct, "_", CC_direction, ".rds"))

PUs_features_split_targets <- readRDS("Results/RDS/crop/PUs_05_features_split_targets.rds")
...
prioritizr_problem <- problem(PUs, 
  ...
  add_relative_targets(0.3) %>% #Change the targets
