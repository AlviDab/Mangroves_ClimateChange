...
map(c("landward", "seaward",
      "mean"), function(CC_direction) {
        ...
        selected_country_difference <- selected_country %>%
          ...
          mutate(diff_global_scale = `Climate-naïve Global-scale` - `Climate-smart Global-scale`,
        ...
        map(c(#"all_comparisons", "Global-scale",
          ...
          dir.create(paste0("Figures/Country/02a_area/RDS"), recursive = TRUE)

          ggsave(plot = plot_comparison, paste0("Figures/Country/02a_area/boxplot_area_",
          ...
          saveRDS(plot_comparison, paste0("Figures/Country/02a_area/RDS/boxplot_area_",
