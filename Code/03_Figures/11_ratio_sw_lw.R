...
map(seq(0.05, 0.3, by = 0.05),
    function(prct) {
      ...
      dir.create(paste0("Figures/Country/11_map_kappa_ratio_lw_sw/", split_group, "/RDS"), recursive = TRUE)

      ggsave(paste0("Figures/Country/11_map_kappa_ratio_lw_sw/",
      ...
      write.xlsx(solution_cc %>%
                 ...
                 file = paste0("Figures/Country/11_map_kappa_ratio_lw_sw/",
                               split_group,"/map_kappa_ratio_lw_sw_", prct, ".xlsx"))

      saveRDS(plot_map, paste0("Figures/Country/11_map_kappa_ratio_lw_sw/",
